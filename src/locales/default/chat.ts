export default {
  ...
  'knowledgeBase.attach.back': 'Back',
  'knowledgeBase.attach.empty': 'No attachable files',
  'knowledgeBase.attach.libraries': 'Libraries',
  'knowledgeBase.attach.title': 'Attach Files',
  ...
  'sendPlaceholder': '提问、创建或开始任务, <hotkey><hotkey/>',
